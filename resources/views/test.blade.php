            ...
            <div class="flex-none w-full max-w-full px-3">
                <div class="relative flex flex-col min-w-0 mb-6 break-words bg-white dark:bg-gray-800 border-0 border-transparent border-solid shadow-xl dark:bg-slate-850 dark:shadow-dark-xl rounded-2xl bg-clip-border">
                    <div class="flex bg-blue-900 items-center justify-center p-6 pb-6 mb-0 border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                        <h6 class="dark:text-white text-gray-100 text-xl uppercase font-mono font-bold">Daftar Pesanan yang Harus Dikirim</h6>
                    </div>
                                ...
                                <table class="items-center w-full mb-0 align-center border-collapse dark:border-white/40 text-slate-500">
                                    <thead class="align-bottom">
                                        <tr>
                                            ...
                                            <th class="px-3 py-3 font-bold text-center uppercase align-middle bg-transparent border-b border-collapse shadow-none dark:border-white/40 dark:text-white text-xxs border-b-solid tracking-none whitespace-nowrap text-slate-400 opacity-70">PILIH</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @php
                                                    ...
                                                    <tr>
                                                                                        ...
                                                                                        <div class="flex justify-between">
                                                                                            ...
                                                                                            <div class="flex items-start">
                                                                                                ...
                                                                                                <div>
                                                                                                    ...
                                                                                                    @endif
                                                                                                    @if ($see->delivery_status == 'deliverd')
                                                        ...
                                                        <td class="p-2 text-center align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent">
                                                            <span class="text-xs font-semibold leading-tight dark:text-white dark:opacity-80 text-slate-400">
                                                                <input type="checkbox" name="checkbox[]" value="{{ $see->id }}" class="w-10 cursor-pointer h-10 appearance-none border border-gray-300  rounded-xl mr-2 checked:bg-no-repeat checked:bg-center checked:bg-blue-900 checked:border-slate-900 ">
                                                            </span>
                                                        </td>
                                                    </tr>
                                                @endif
                                        ...
                                        @if (!$AcceptedStatus)
                                            <td colspan="6" class="p-2 align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent">
                                                <p class="text-center text-3xl py-8 font-bold text-blue-900">Belum Ada Pesanan yang Harus Diantar</p>
                                            </td>
                                        @endif
                                    </tbody>
                                    <tfoot>
                                        @if ($see->transaction_status == 'accepted')
                                            <tr>
                                                <td colspan="7" class="p-4 text-right bg-transparent border-t dark:border-white/40 shadow-transparent">
                                                    <button type="submit" class="text-white uppercase bg-blue-800 hover:bg-blue-900 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-md px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
                                                        <i class="bi bi-bookmark-plus-fill text-md"></i>Tambahkan ke Daftar Pesanan</button>
                                                </td>
                                            </tr>
                                        @endif
                                    </tfoot>
