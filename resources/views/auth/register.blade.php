                ...
                <div class="md:max-w-md w-full px-4 py-4">
                    <form action="{{ route('auth.register') }}" method="POST">
                        ...
                        <div class="mb-12">
                            ...
                            <p class="text-sm mt-4 text-gray-800">Sudah Memiliki Akun? <a href="{{ route('login') }}" class="text-blue-900 font-semibold hover:underline ml-1 whitespace-nowrap">Login</a></p>
                        </div>

                        <div>
                            <label class="text-gray-800 text-xs block mb-2">Username</label>
                            <div class="relative flex items-center">
                                <input name="name" type="text" required class="w-full text-gray-800 bg-slate-50 text-sm border-b border-gray-300 focus:border-blue-900 px-2 py-3 outline-none" placeholder="Masukkan username" />
                        ...
                        <div class="mt-5">
                            ...
                            <div class="relative flex items-center">
                                <input name="email" type="email" required class="w-full text-gray-800 bg-slate-50 text-sm border-b border-gray-300 focus:border-blue-900 px-2 py-3 outline-none" placeholder="Masukkan email" />
                                <svg xmlns="http://www.w3.org/2000/svg" fill="#bbb" stroke="#bbb" class="w-[18px] h-[18px] absolute right-2" viewBox="0 0 682.667 682.667">
                                    <defs>
                                        <clipPath id="a" clipPathUnits="userSpaceOnUse">
                                            <path d="M0 512h512V0H0Z" data-original="#000000"></path>
                        ...
                        <div class="mt-5">
                            ...
                            <div class="relative flex items-center">
                                <input name="password" type="password" required class="w-full text-gray-800 text-sm bg-slate-50 border-b border-gray-300 focus:border-blue-900 px-2 py-3 outline-none" placeholder="Masukkan password" />
                        ...
                        <div class="mt-12">
                            <button class="w-full shadow-xl py-2.5 px-4 text-sm tracking-wide rounded-md text-white transition-colors duration-200 bg-blue-800 hover:bg-blue-900 focus:outline-none">
                                Buat Akun
                            </button>
                        </div>
                    </form>
